...
<body>
   <header>
    ...
    <div class="wraper">
        ...
        <div class="questao">
         <h2> Questao 4 </h2>
         <form action="lista3.php" method="post" id="form4a">
            <fieldset>
               <legend> Informações do primeiro aluno: </legend>
               <label for="matricula1"> Matrícula: </label>
               <input type="text" name="matricula1"><br>
         ...
         <button form="form4a" type="submit" class="button" name="submit_form4a"> Enviar </button>
         <form action="lista3.php" method="post" id="form4b">
            <fieldset>
         ...
         <button form="form4b" type="submit" class="button" name="submit_form4b"> Pesquisar </button>
        </div>  
         <!-- Questão 5: Mesma que a 2, porém agora organizando os alunos por média final de forma decrescente -->
        <div class="questao">
         <h2> Questao 2 </h2>
    ...
    <div class="amostra">
      ...
      // ESPAÇO PARA A QUESTÃO 5, MOSTRAR EM FORMATO TABULAR DESCENDENTE PELA NOTA
      $aluno1 = $_POST['nome1'];
      $aluno2 = $_POST['nome2'];
      $aluno3 = $_POST['nome3'];
