...
-- DESAFIO
INSERT INTO (IdFornecedor, IdProduto, Disponiveis, Custo) VALUES ('1', '3', '200', '0.12') 
SELECT * FROM FORNECEDORES f1 JOIN PEDIDOS p1 ON f1.IdFornecedores = p1.IdFornecedores JOIN PRODUTOS p2 ON p1.IdProdutos = p2.IdProdutos;